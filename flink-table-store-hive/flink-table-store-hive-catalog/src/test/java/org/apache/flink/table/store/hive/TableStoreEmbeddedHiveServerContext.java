...
public class TableStoreEmbeddedHiveServerContext implements HiveServerContext {
	...
	TableStoreEmbeddedHiveServerContext(TemporaryFolder basedir, HiveRunnerConfig hiveRunnerConfig) {
