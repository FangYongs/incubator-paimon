...
import org.apache.flink.table.store.hive.HiveCatalogConfig;
import org.apache.flink.table.store.hive.SqlAlterHiveTable;
import org.apache.flink.table.store.hive.SqlCreateHiveTable;
import org.apache.flink.table.store.hive.TableStoreHiveException;
import org.apache.flink.table.store.hive.client.HiveMetastoreClientWrapper;
import org.apache.flink.table.store.hive.client.HiveShim;
import org.apache.flink.table.store.hive.conversion.HiveInspectors;
...
import static org.apache.flink.table.store.hive.SqlAlterHiveTable.ALTER_TABLE_OP;
import static org.apache.flink.table.store.hive.SqlCreateHiveTable.HiveTableRowFormat.SERDE_INFO_PROP_PREFIX;
import static org.apache.flink.table.store.hive.SqlCreateHiveTable.HiveTableRowFormat.SERDE_LIB_CLASS_NAME;
import static org.apache.flink.table.store.hive.SqlCreateHiveTable.HiveTableStoredAs.STORED_AS_FILE_FORMAT;
import static org.apache.flink.table.store.hive.SqlCreateHiveTable.HiveTableStoredAs.STORED_AS_INPUT_FORMAT;
import static org.apache.flink.table.store.hive.SqlCreateHiveTable.HiveTableStoredAs.STORED_AS_OUTPUT_FORMAT;
import static org.apache.flink.table.store.hive.SqlCreateHiveTable.TABLE_IS_EXTERNAL;
import static org.apache.flink.table.store.hive.SqlCreateHiveTable.TABLE_LOCATION_URI;
...
public class HiveTableUtil {
     ...
     * @throws TableStoreHiveException Thrown, if the source or sink table is transactional.
     */
