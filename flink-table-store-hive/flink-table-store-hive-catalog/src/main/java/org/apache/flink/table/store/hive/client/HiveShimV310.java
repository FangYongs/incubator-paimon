...
public class HiveShimV310 extends HiveShimV239 {
    ...
    public Object toHiveTimestamp(Object flinkTimestamp) {
        ...
        try {
            ...
            throw new TableStoreHiveException("Failed to convert to Hive timestamp", e);
        }
    }
    ...
    public LocalDateTime toFlinkTimestamp(Object hiveTimestamp) {
        ...
        try {
            ...
            throw new TableStoreHiveException("Failed to convert to Flink timestamp", e);
        }
    }
    ...
    public Object toHiveDate(Object flinkDate) {
        ...
        try {
            ...
            throw new TableStoreHiveException("Failed to convert to Hive date", e);
        }
    }
    ...
    public LocalDate toFlinkDate(Object hiveDate) {
        ...
        try {
            ...
            throw new TableStoreHiveException("Failed to convert to Flink date", e);
        }
    }
    ...
    public Writable hivePrimitiveToWritable(Object value) {
        ...
        try {
            ...
            throw new TableStoreHiveException("Failed to create writable objects", e);
        }
        throw new TableStoreHiveException(
    ...
    public void loadTable(
        ...
        try {
            ...
            throw new TableStoreHiveException("Failed to load table", e);
        }
    }
    ...
    public void loadPartition(
        ...
        try {
            ...
            throw new TableStoreHiveException("Failed to load partition", e);
        }
    }
